...
/*
   ...
   a context-owned list of open local file handles (pta_open_handles) and
   smb2_free_open_handles(), used by lib/init.c.
...
struct smb2_context {
        struct smb2fh *pta_open_handles;
...
/* Photo Transfer: context-owned local file handle cleanup, after callbacks drain. */
void smb2_free_open_handles(struct smb2_context *smb2);
